...
local function lsp_keymaps(bufnr)
	...
	vim.api.nvim_buf_set_keymap(bufnr, "n", "tgd", "<cmd>tab split | lua vim.lsp.buf.definition()<CR>", opts)
	vim.api.nvim_buf_set_keymap(bufnr, "n", "gd", "<cmd>tab split | lua vim.lsp.buf.definition()<CR>", opts)
	vim.api.nvim_buf_set_keymap(bufnr, "n", "gsd", "<cmd>lua vim.lsp.buf.definition()<CR>", opts)
...
if not status_ok then
	vim.notify("autocomplete for nvim lsp not working!")
	return
end
...
M.on_attach = function(client, bufnr)
	...
	if client.name then
		...
		print("Could not connect to a lanaguage server...")
	end
